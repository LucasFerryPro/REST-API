...
// F2 : Étant donné usn identifiant, affichez les informations du lauréat avec cet identifiant (prénom, nom, les prix remportés).
const getLaureate = "SELECT laureates.firstname, laureates.surname, prizes.year, nominations.motivation FROM laureates INNER JOIN nominations ON laureates.id_laureate = nominations.id_laureate INNER JOIN prizes ON nominations.id_prize = prizes.id_prize WHERE laureates.id_laureate = $1";
